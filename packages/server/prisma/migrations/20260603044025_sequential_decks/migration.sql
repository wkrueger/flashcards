...
-- AlterTable
ALTER TABLE "Subject" ADD COLUMN "order" INTEGER;
...
INSERT INTO "new_Deck" ("completionComputedAt", "completionScore", "createdAt", "defaultBackLanguageId", "defaultFrontLanguageId", "id", "inverseReviewEnabled", "inverseReviewStreak", "name", "speechRecognitionEnabled", "userId") SELECT "completionComputedAt", "completionScore", "createdAt", "defaultBackLanguageId", "defaultFrontLanguageId", "id", "inverseReviewEnabled", "inverseReviewStreak", "name", "speechRecognitionEnabled", "userId" FROM "Deck";
DROP TABLE "Deck";
