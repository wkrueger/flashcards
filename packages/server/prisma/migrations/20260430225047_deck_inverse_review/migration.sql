...
INSERT INTO "new_Deck" ("createdAt", "defaultBackLanguageId", "defaultFrontLanguageId", "id", "name", "userId") SELECT "createdAt", "defaultBackLanguageId", "defaultFrontLanguageId", "id", "name", "userId" FROM "Deck";
DROP TABLE "Deck";
