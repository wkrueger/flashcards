...
INSERT INTO "new_Deck" ("completionComputedAt", "completionScore", "createdAt", "defaultBackLanguageId", "defaultFrontLanguageId", "id", "inverseReviewEnabled", "inverseReviewStreak", "name", "sequentialEnabled", "speechRecognitionEnabled", "userId") SELECT "completionComputedAt", "completionScore", "createdAt", "defaultBackLanguageId", "defaultFrontLanguageId", "id", "inverseReviewEnabled", "inverseReviewStreak", "name", "sequentialEnabled", "speechRecognitionEnabled", "userId" FROM "Deck";
DROP TABLE "Deck";
